...
# Inicializar el controlador del navegador (Chrome en este caso)
# Especifica la ruta completa al chromedriver
driver_path = "C:/Users/tryou/Documents/chromedriver/chromedriver_win32/chromedriver.exe"
...
def control_browser(command):
    if "buscar" in command:
        ...
        website = command.replace("abrir", "").strip()
